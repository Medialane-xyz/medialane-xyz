export const mockCreators = [
  ...
  {
    id: "9",
    name: "Himalayas Records",
    username: "himalayas",
    avatar: "/himalayas-records-avatar.png",
    banner: "/himalayas-records-banner.jpg",
    bio: "Record label from Brazil.",
    verified: true,
    followers: 764,
    following: 11,
    totalAssets: 34,
    totalSales: 9,
    volumeTraded: "590 STRK",
    joinedDate: "2025-10-22",
    location: "Brazil",
    website: "https://kalamaha.com",
    twitter: "@himalayasrecords",
    specialties: ["Music", "Rock", "Pop"],
    achievements: ["Music", "Brazil"],
  },
  {
    id: "10",
    name: "Mediolano",
  ...
  },
  {
    ...
    name: "Sal",
    username: "sal",
    avatar: "/sal-imagem.jpg",
    banner: "/sal-banner.jpg",
    bio: "Salvador Camino",
    verified: true,
    followers: 12,
    following: 1,
    totalAssets: 49,
    totalSales: 29,
    volumeTraded: "490 STRK",
    joinedDate: "2025-06-08",
    location: "Brazil",
    website: "https://kalamaha.com.br",
    twitter: "@salvadorcamino",
    specialties: ["Photography", "Music", "Art"],
    achievements: ["Brazil", "Rio de Janeiro"],
  },
  {
    id: "13",
...
export const mockCategories = [
  {
    ...
    name: "Art",
    slug: "art",
    description: "Original artworks, illustrations, paintings, and visual creations",
  ...
  },
  {
    ...
    name: "Video",
    slug: "video",
    description: "Video content, animations, videocasts, and film assets",
